...
function Tile({num}) {
  return (
    <div className='leading-9' style={{color: COLORS[num]}}>
      {num > 200 ? num-201 : '.'}
    </div>
  )
}
...
function App() {
  ...
  return (
    <div className='cursor-pointer relative text-3xl font-mono bg-zinc-50 dark:bg-black text-zinc-50 dark:text-black w-full min-h-[100svh] px-4 py-8 flex flex-col justify-center items-center bg-gradient-to-br select-none'>
      ...
      <div className='fixed top-0 left-0 right-0 bottom-0 bg-zinc-50 dark:bg-black backdrop-blur-lg hover:bg-transparent hover:backdrop-blur-none duration-500 ease-in-out'></div>
    </div>
  )
}
